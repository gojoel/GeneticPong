...
// 	called from pong.cc for each move of the left paddle 
//---------------------------------------------------------------------
...
//---------------------------------GetVelocity--------------------------------
//	find the y velocity for paddle
//-----------------------------------------------------------------------
...
float GenAlg::GetVelocity(Paddle *p1, Paddle *p2, Ball *ball, vector<double> &chromo)
{
	...
	return chromo[2] * ball->dy + chromo[0] * ball->y + chromo[1] * p1->y;
}
...
vector<Genome> GenAlg::Populate(vector<Genome> &oldPop){
